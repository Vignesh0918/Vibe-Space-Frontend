 ...
 * FollowersScreen.js
 * 
 * High-fidelity screen listing users following a specific user in VibeSpace.
 * Supports filtering followers locally, quick navigation to their profiles,
 * and quick follow/unfollow actions.
 */
...
export default function FollowersScreen() {
  ...
  const [actionUserId, setActionUserId] = useState(null); // Track which user is currently triggering follow API

  const fetchFollowers = async (isPull = false) => {
    if (isPull) {
